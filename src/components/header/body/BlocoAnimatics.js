...
function BlocoAnimatics(){
  ...
  const{
    ...
    <div class="row align-items-center g-lg-5 py-5">
      <div class="col-lg-5 text-center text-lg-start" id="hiperquimica-animatics">
        <h2 class="display-4 fw-bold lh-1 text-light mb-3">2D ANIMATIC</h2>
        <p class="col-lg-10 fs-4 text-light animatics-texto-hiper">Roteiros são transformados em cenas animadas com ilustrações originais que capturam a essência de cada narrativa. Roteiros que ganham vida quadro a quadro</p>
