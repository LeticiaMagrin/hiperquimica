    ...
    return(
        ...
        <div className='rodape'>
            ...
            <footer className="py-3">
                ...
                <li className="nav-item"><Link to='/sobre' className="nav-link px-2 text-light ">QUEM SOMOS</Link></li>
                <li className="nav-item"><Link to='/contato' className="nav-link px-2 text-light ">CONTATO</Link></li>
